### TODO
### add club codes
### add goalkeeping and mental attributes
...
def loadData(filePath, allowExceptions = True):
    try:
...
def createLeagues():
    leaguesData = loadData(files['leagues'])
    for leagueData in leaguesData:
        for nation in Nation.instances:
            if nation.ucName == leagueData['nation']:
...
def saveSetup():
    clear()
    while True:
        filePath = input('<ugreen>Let\'s save your starting setup!</ugreen>\n<uyellow>Choose the name of the file it\'ll be saved in:</uyellow> ', default = hero.ucFullName) + fileExtension
        print()
        if not filePath:
...
class Nation:
    ...
    def __init__(self, names, shortName, nationality, color, fifaRanking):
        ...
        self.leagues = []
        self.clubs = []
        self._searchOptions = [str(self.fifaRanking), self.ucShortName] + [nationName.lower() for nationName in self.ucNames]
...
class Player:
    ...
    def viewProfile(self):
        ...
        print(f'Preferred position: {self.primaryPosition.name}.')
        ...
        print(f'\n{"<bold>Traits:</bold>"}')
        for trait in sorted(self.traits, key = lambda x: x.ucNum):
...
class Club:
    ...
    def __init__(self, ovr, fullName, names, nickname, colors):
        ...
        self._searchOptions = [self.ucFullName.lower(), self.ucNickname.lower()] + [clubName.lower() for clubName in self.ucNames]
...
class League:
    ...
    def __init__(self, name, nation, clubs):
        ...
        self._searchOptions = [self.ucName.lower()] + [f'{nationName.lower()} {self.level}' for nationName in self.nation.ucNames]
